    ...
    const contactItems = [
        {
            ...
            label: 'Email',
            value: 'jayanthvishnu56@gmail.com',
                                ...
                                {contactItems.map((item) => (
                                    <div key={item.label} className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            {item.href ? (
                                                <a href={item.href} className="text-sm text-slate-200 hover:text-indigo-300 transition-colors">
                                                    {item.value}
                                                </a>
                                            ) : (
                        ...
                        <div className="flex gap-3">
                            {socials.map((s) => (
                                <a
                                    ...
                                    className="flex items-center gap-2 px-4 py-2.5 rounded-xl glass-card border border-slate-700/40 hover:border-indigo-500/40 text-slate-400 hover:text-slate-200 transition-all text-sm font-medium"
                                >
